...
<div class="includetitle">Non</div>

<div class="includetext">I have been wanting to get #3 forveer but they don't sell it in the Netherlands! Does anyone know if I can get it in Nova Scotia, Canada? This post though reminds me that I need to go buy lingerie soon. Similar to #10 would be nice.</div>
...
<div><label for="mcc_name">Your name:</label></div>

<div><input type="text" name="mcc_name" id="mcc_name" class="formfields" maxlength="20" value=""></div>

</div>

<div class="includetext">

<div><label for="mcc_text">Your comment:</label></div>

<div><textarea name="mcc_text" id="mcc_text" class="formfields" rows="12" cols="80" style="height: 12em;"></textarea></div>

</div>

<div class="includetext">

<div>![captcha](/site/captcha.jpg) <label for="mcc_captcha">Please type the letters shown in the image, or hit submit to get another one:</label> <input type="text" name="mcc_captcha" id="mcc_captcha" class="formfields" style="width: 8em;"></div>

<div style="margin-top: 1em; clear: both;"><input type="button" value="Submit comment" onclick="javascript:submitComment();"></div>
...
© [Shannon Haworth](http://build.spaceopera.org) | Design by [Andreas Viklund](http://andreasviklund.com)
